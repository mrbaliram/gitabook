...
class BookController extends Controller
{
    ...
    public function volunteer_book_check($id)
    {
        ...
        return view('volunteer.volunteer_book_check', ['bookReturnResult' => $bookReturnResult, 'bookIssueResult' => $bookIssueResult, 'paymentResult' => $paymentResult, 'bookSellResult' => $bookSellResult]);
