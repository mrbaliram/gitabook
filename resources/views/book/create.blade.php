                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('book.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <!-- category category_id // language_id-->
                            <div class="relative z-0 w-full mb-6 group">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <select id="author_id" name="author_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                    <option value="">--Choose one option--</option>
                                    @foreach($authorsResults as $autherData)
                                        <option value="{{ $autherData->id }}"> {{ $autherData->name }} </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="text" name="name" id="name" value="{{old('name')}}" class="border rounded-md w-full py-2 px-3 text-gray-700" required>
                            </div>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="number" name="price" id="price" value="{{old('price')}}" class="border rounded-md w-full py-2 px-3 text-gray-700" required>
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
