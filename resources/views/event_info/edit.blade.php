        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('events.update', $results->id) }}" 
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="event_name" id="event_name" value="{{old('name', $results->event_name ?? '')}}" class="border rounded-md w-full py-2 px-3 text-gray-700" required>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="text" name="leader_name" id="leader_name" value="{{old('name', $results->leader_name ?? '')}}" class="border rounded-md w-full py-2 px-3 text-gray-700">
                            </div>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="text" name="leader_contact_no" id="leader_contact_no" value="{{old('name', $results->leader_contact_no ?? '')}}" class="border rounded-md w-full py-2 px-3 text-gray-700">
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                                <label for="leader_alternate_no" class="block text-gray-600 font-medium">Leader Alternate No</label>
                                <input type="text" name="leader_alternate_no" id="leader_alternate_no" value="{{old('name', $results->leader_alternate_no ?? '')}}" class="border rounded-md w-full py-2 px-3 text-gray-700">
                            </div>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="text" name="place_contact_person" id="place_contact_person" value="{{old('name', $results->place_contact_person ?? '')}}" class="border rounded-md w-full py-2 px-3 text-gray-700">
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                                <label for="leader_alternate_no" class="block text-gray-600 font-medium">Leader Alternate No</label>
                                <input type="text" name="leader_alternate_no" id="leader_alternate_no" value="{{old('name', $results->leader_alternate_no ?? '')}}" class="border rounded-md w-full py-2 px-3 text-gray-700">
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                ...
                                <input type="text" name="place_contact_no" id="place_contact_no" value="{{old('name', $results->place_contact_no ?? '')}}" class="border rounded-md w-full py-2 px-3 text-gray-700">
                            </div>
                            <div class="relative z-0 w-full mb-6 group">
                                <label for="place_alternate_no" class="block text-gray-600 font-medium">Place Alternate No</label>
                                <input type="text" name="place_alternate_no" id="place_alternate_no" value="{{old('name', $results->place_alternate_no ?? '')}}" class="border rounded-md w-full py-2 px-3 text-gray-700">
                            </div>
                        </div>
