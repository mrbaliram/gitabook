                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4 flex justify-end">
                        ...
                        @if(Auth::user()->type == 'admin')
                            ...
                            <a href="{{ route('volunteer.add') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 flex">
                                ...
                                @foreach($results as $data)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td  class="px-6 py-4 flex">
                                            @if(Auth::user()->type == 'admin' || Auth::user()->id == $data->id)
                                                
                                                <a href="{{ route('volunteer.edit', $data->id) }}" class="text-blue-600 hover:underline" title="Edit / Update">
                                                    <svg class="h-6 w-6 text-blue-600"  viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M9 7 h-3a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-3" />  <path d="M9 15h3l8.5 -8.5a1.5 1.5 0 0 0 -3 -3l-8.5 8.5v3" />  <line x1="16" y1="5" x2="19" y2="8" /></svg>
                                                </a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                <form action="{{ route('volunteer.delete', $data->id) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            @endif
                                            &nbsp;&nbsp;&nbsp;&nbsp;<a title="View Report" href="{{ route('book.volunteer_book_check', $data->id) }}" class="text-blue-600 hover:underline">
                                                <svg class="h-6 w-6 text-blue-600"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <polygon points="12 2 2 7 12 12 22 7 12 2" />  <polyline points="2 17 12 22 22 17" />  <polyline points="2 12 12 17 22 12" /></svg>
